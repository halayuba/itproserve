<section id="ourProjects" class="g-py-90">
  <div class="text-center g-mb-60">
    <div class="container g-max-width-770">
      ...
      <p class="mb-0">From simple &amp; static websites (visit <a href="http://dashemirates.com/">Dash Emirates</a> and <a href="http://refugeenewhome.org/">Refugee New Home</a>), to generic industry dashboards, to more complex tailer-made business solutions, we are currently working on a variety of challenging projects.</p>
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-md-4 g-mb-30 g-mb-0--md">
        <article class="g-bg-gray-light-v5">
          <a href="http://​www.jobsave.io"><img class="img-fluid w-100" src="public/img/projects_jobsave.png"></a>

          <div class="g-pa-30">
            <h3 class="text-uppercase g-font-weight-700 g-font-size-default g-mb-20">
              <a href="http://​www.jobsave.io" class="g-color-gray-dark-v1 g-color-primary--hover">Job Save ( ​www.jobsave.io ​)</a>
            </h3>
      ...
      <div class="col-md-4 g-mb-30 g-mb-0--md">
        <article class="g-bg-gray-light-v5">
          <a href="http://​www.flextask.io"><img class="img-fluid w-100" src="public/img/projects_flextasks.png"></a>

          <div class="g-pa-30">
            <h3 class="text-uppercase g-font-weight-700 g-font-size-default g-mb-20">
              <a href="http://www.flextask.io" class="g-color-gray-dark-v1 g-color-primary--hover">Flex Tasks ( ​www.flextasks.io ​)</a>
            </h3>
      ...
      <div class="col-md-4">
        <article class="g-bg-gray-light-v5">
          ...
          <div class="g-pa-30">
            ...
            <p class="mb-0">The aim of this project is to be a self-managed flexible restaurant solution that can grow with the business. The first Sprint of this project is focused on generating Dynamic Menus.</p>
          </div>
        </article>
      </div>
    </div>
