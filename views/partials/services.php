<section id="services" class="g-pt-90">
  <div class="text-center g-mb-60">
    <div class="container g-max-width-770">
      <h2 class="text-uppercase g-line-height-1 g-font-weight-700 g-font-size-30 g-color-gray-dark-v1 g-mb-15">services &amp; technology</h2>

      <p class="mb-0">We are focused exclusively on PHP and open-source tools &amp; packages.</p>
    </div>
  </div>

  <!-- Dynamic Process -->
  <div class="js-carousel g-pb-50 g-pb-0--md g-pt-130--md" data-infinite="true" data-pagi-classes="u-carousel-indicators-v6 text-center g-width-780--md">
    ...
    <!-- TOOLS -->
    <div class="js-slide" data-title="TOOLS">
      <div class="row mx-0">
        <div class="col-sm-7 col-md-6 text-center text-md-left g-theme-bg-gray-dark-v1 g-py-50 g-py-100--md g-px-15 g-px-50--md">
        ...
        <div class="col-sm-5 col-md-6 g-min-height-360 g-bg-img-hero g-px-0" style="background-image: url(public/img/tools.jpg);"></div>
      </div>
    </div>

    <!-- DISCIPLINES -->
    <div class="js-slide" data-title="DISCIPLINES">
      <div class="row mx-0">
        <div class="col-sm-7 col-md-6 text-center text-md-left g-theme-bg-gray-dark-v1 g-py-50 g-py-100--md g-px-15 g-px-50--md">
          <h3 class="text-uppercase g-font-weight-800 g-font-size-default i_color g-mb-25">DISCIPLINES</h3>
          <p class="g-mb-10">Project Management</p>
          <p class="g-mb-10">Solution architecture design</p>
          <p class="g-mb-10">Business Analysis</p>
